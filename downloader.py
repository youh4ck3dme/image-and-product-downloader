...
def _sanitize_filename(filename):
    ...
    # Remove characters that are not alphanumeric, dots, hyphens, or
    # underscores
    ...
    def _download_image(self, img_url):
        ...
        try:
            ...
            if not filename or '.' not in filename:
                ...
                filename = f"image_{img_hash}.jpg"
...
class ProductDownloader:
    ...
    def extract_products(self, url):
        ...
        product_elements = soup.find_all(
            ['article', 'div'], class_=lambda x: x and ('product' in x.lower()))
    ...
    def _extract_product_info(self, element):
        ...
        title_elem = element.find(['h1', 'h2', 'h3', 'h4'], class_=lambda x: x and (
            'title' in x.lower() or 'name' in x.lower()))
        if title_elem:
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description='Download images and product information from websites')
